...
export const conversationController = {
    ...
    addConversation: catchAsync(async (req: Request, res: Response, next: NextFunction) => {
        ...
        const conversation = await conversationServices.addConversationService(ownerId, contactId , savedName)
    ...
    deleteConversation: catchAsync(async (req: Request, res: Response, next: NextFunction) => {
        ...
        const conversation = await conversationServices.deleteConversationService(conversationId as string)
